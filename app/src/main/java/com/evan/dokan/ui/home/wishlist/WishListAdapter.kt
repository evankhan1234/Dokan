...
class WishListAdapter (val context: Context, val product: MutableList<Product>?, val productCategoryWiseUpdateListener: IProductCategoryWiseUpdateListener,val wishDeleteListener:IWishListDeleteListener) : RecyclerView.Adapter<WishListAdapter.CustomViewHolder>() {
