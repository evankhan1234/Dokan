...
import com.evan.dokan.ui.home.dashboard.product.*
...
class ProductSearchFragment : Fragment() , KodeinAware, IProductCategoryWiseListener,
    IProductCategoryWiseUpdateListener {
    override val kodein by kodein()

    private val factory : ProductSearchModelFactory by instance()
...
//        imm.showSoftInput(edit_content, InputMethodManager.SHOW_IMPLICIT)
        ...
        edit_content = root?.findViewById(R.id.edit_content)
        viewModel = ViewModelProviders.of(this, factory).get(ProductSearchViewModel::class.java)
